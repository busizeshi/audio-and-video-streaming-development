...
namespace LQF
{
        ...
        case RTMP_BODY_VID_CONFIG:
            {
                ...
                auto* vid_cfg_msg = (VideoSequenceHeaderMsg*)data;
        ...
        case RTMP_BODY_VID_RAW:
            {
                ...
                auto* nalu = (NaluStruct*)data;
                if (sendH264Packet((char*)nalu->data, nalu->size, (nalu->type == 0x05),
                                   nalu->pts))
                {
        ...
        case RTMP_BODY_AUD_SPEC:
            {
                ...
                auto* audio_spec = (AudioSpecMsg*)data;
                uint8_t aac_spec_[4];
                aac_spec_[0] = 0xAF;
        ...
        case RTMP_BODY_AUD_RAW:
            {
                ...
                auto* audio_raw = (AudioRawMsg*)data;
    ...
    bool RTMPPusher::sendH264Packet(char* data, int size, bool is_keyframe, unsigned int timestamp)
    {
        ...
        auto* body = new unsigned char[size + 9];
