...
namespace LQF
{
    ...
    */
    ...
    public:
        ...
        void Pack(RTMPPacket* packet, char* buf, const char* data, int length) const override;
        void Metadata(RTMPPacket* packet, char* buf, const char* data, int length) const override;

        static int GetAudioSpecificConfig(uint8_t* data, uint32_t profile, uint32_t samplerate,
